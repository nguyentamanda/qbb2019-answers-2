...
fig, ax = plt.subplots()
ax.plot(temp, statwghtfolded1, color = "red", label = "Case 1")
ax.plot(temp, statwghtfolded2, color = "blue", label = "Case 2")
ax.plot(temp, statwghtfolded3, color = "green", label = "Case 3")

plt.legend(loc = "upper right")
fig.set_size_inches(10,5)
plt.tight_layout()
fig.savefig("2_Population_Simulations_B.png")
plt.close(fig)